...
export function PostComment() {
    ...
    return (
        <form className="font-bold flex justify-center gap-4" onSubmit={postComment}>
            <label className="font-bold pr-4">
                Post Comment
                <input className="border border-black dark:border-white p-1 rounded" value={newComment}
                    onChange={(event) => setNewComment(event.target.value)}
                />
            </label>
            <button className="font-bold border border-black dark:border-white  p-1 rounded cursor-pointer" type="submit">Submit</button>
        </form>
    )
}
...
export function DeleteComment({comment_id}) {
    ...
    return (
        <div className="font-bold flex justify-center">
            <button className="font-bold border border-black dark:border-white  p-1 rounded cursor-pointer" onClick={() => handleDeletion(comment_id)}>
                DeleteComment
            </button>
        </div>
    )
